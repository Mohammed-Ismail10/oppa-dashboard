...
export default function RoomCategories() {
  ...
  let { data, isLoading, refetch } = useQuery('roomCategory', getData, {
    cacheTime: 60000,
      ...
      <div className={`${style.heightItems}`}>
        ...
        <div className='pt-5 mt-3 ms-4'>
          <Navbar className={`justify-content-between align-items-start`}>
            ...
            <Nav className='w-50 justify-content-center ps-5'>
              <div className={`${style.searchWidth} position-relative rounded-2 w-50`}>
              ...
              <NavLink onClick={() => dispatch(handleShowDelete())} className={`deleteHover ${style.shadowBtn} ${style.flexNone} ms-5 px-3 rounded-3 border-0 btn fs15 text-main fw-bold nav-link ${showDelete ? 'deleteActive' : ''} bg-white `}>
                مسح الكل
              </NavLink>
            </Nav>
          </Navbar>
