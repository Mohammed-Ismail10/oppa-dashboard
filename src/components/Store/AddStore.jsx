          ...
          <div>
            ...
            <div className="row">
              <div className="col-6 pb-4">
                <label className='fs15 pb-2' htmlFor="fullName">نوع الهدية</label>
                <input className={`${style.holder} py-3 form-control`} name='fullName' type="number" id='fullName' placeholder=' الرجاء إدخال نوع الهدية' />
              </div>
              <div className="col-6 pb-4">
                <label className='fs15 pb-2' htmlFor="userName">الاسم</label>
                <input className={`${style.holder} py-3 form-control`} name='userName' type="number" id='userName' placeholder='الرجاء إدخال الاسم' />
              </div>
              <div className="col-6 pb-4">
                <label className='fs15 pb-2' htmlFor="userName">السعر</label>
                <input className={`${style.holder} py-3 form-control`} name='userName' type="number" id='userName' placeholder='253' />
              </div>
              <div className="col-6 pb-4">
                <label className='fs15 pb-2' htmlFor="userName">الصلاحية</label>
                <input className={`${style.holder} py-3 form-control`} name='userName' type="number" id='userName' placeholder='253' />
              </div>
