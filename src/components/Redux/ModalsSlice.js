...
let initialState = { showChangeId: false, showEditRow: false, showDelete: false, showDeleteRow: false, rowId: null };
...
export let { handleShowChangeId, handleCloseChangeId, handleShowDelete, handleCloseDelete, handleShowDeleteRow, handleCloseDeleteRow, handleShowEditRow, handleCloseEditRow } = modalsSlice.actions;